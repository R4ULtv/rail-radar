...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    bounds: [11.0, 55.3, 24.2, 69.1],
    description:
      "Transdev is a global public transport operator headquartered in France, running rail, bus, tram, and ferry services across 17+ countries. In Sweden, Transdev operates regional rail services and the Snälltåget long-distance brand through its subsidiary Transdev Sverige AB.",
