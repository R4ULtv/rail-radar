...
export const brands: Brand[] = [
  ...
  // Swedish brands
  {
    ...
    description:
      "SJ AB is Sweden's state-owned national rail operator, running high-speed, intercity, regional, and night-train services across the country. Operating the X 2000 and SJ 3000 tilting trains, SJ connects all major Swedish cities and also runs international routes to Oslo and Copenhagen.",
    website: "https://www.sj.se",
    founded: 2001,
    headquarters: "Stockholm, Sweden",
    networkKm: 7000,
    annualPassengers: 45_000_000,
    serviceTypes: ["high-speed", "intercity", "regional", "night-train", "international"],
    parentCompany: null,
    links: [
  ...
  },
  {
    ...
    description:
      "MTR Express is Sweden's first private open-access intercity rail operator, running frequent services between Stockholm and Göteborg. A subsidiary of Hong Kong's MTR Corporation, it competes directly with SJ on Sweden's busiest rail corridor.",
  ...
  },
  {
    ...
    bounds: [11.0, 55.3, 24.2, 69.1],
    description:
      "Transdev is a global public transport operator headquartered in France, running rail, bus, tram, and ferry services across 17+ countries. In Sweden, Transdev operates commuter and regional rail services including Stockholm commuter trains and the Snälltåget long-distance brand.",
    ...
    serviceTypes: ["regional", "commuter"],
    parentCompany: "Caisse des Dépôts",
    links: [
