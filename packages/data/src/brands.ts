...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    logoPath: "vr",
    countries: ["fi", "se"],
    bounds: [11.0, 55.3, 31.6, 70.1],
    description:
      "VR Group is Finland's state-owned railway company, operating high-speed Pendolino, InterCity, commuter, and freight services on Finland's 1,524 mm broad-gauge network. Since 2022, VR has expanded into Sweden through VR Sverige (formerly Arriva Sverige), operating Pågatågen, Östgötapendeln, and Tåg i Bergslagen regional services, plus the Stockholm–Göteborg high-speed corridor (formerly MTR Express, acquired 2024).",
  ...
  },
  {
    slug: "flixtrain",
    name: "FlixTrain",
    logoPath: "de/flixtrain",
    countries: ["de"],
    bounds: [6.0, 47.3, 15.0, 55.1],
    description:
      "FlixTrain is a low-cost open-access long-distance train operator in Germany, run by FlixMobility. It competes directly with Deutsche Bahn on popular intercity routes, offering affordable fares on services between major cities like Berlin, Hamburg, Munich, and Cologne.",
    website: "https://www.flixtrain.de",
    founded: 2018,
    headquarters: "Munich, Germany",
    networkKm: null,
    annualPassengers: null,
    serviceTypes: ["intercity"],
    parentCompany: "FlixMobility",
    links: [
      { label: "Official Site", url: "https://www.flixtrain.de", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/FlixTrain", type: "wikipedia" },
    ],
  },
  {
    slug: "arriva",
    ...
    logoPath: "arriva",
    countries: ["uk", "nl", "de"],
    bounds: [-5.7, 47.3, 15.0, 55.1],
    description:
      "Arriva is a major European transport operator owned by Deutsche Bahn, running regional rail services across multiple countries. In Germany it operates as alex and Länderbahn in Bavaria, in the Netherlands as Arriva Nederland, and in the UK as Arriva Trains. It also operates bus and rail services in the Czech Republic, Poland, and other European markets.",
    website: "https://www.arriva.co.uk",
    founded: 1938,
    headquarters: "Sunderland, United Kingdom",
    networkKm: null,
    annualPassengers: null,
    serviceTypes: ["regional"],
    parentCompany: "Deutsche Bahn",
    links: [
      { label: "Official Site", url: "https://www.arriva.co.uk", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/Arriva", type: "wikipedia" },
    ],
  },
  {
    slug: "hlb",
    ...
    logoPath: "de/hlb",
    countries: ["de"],
    bounds: [7.8, 49.4, 10.2, 51.7],
    description:
      "Hessische Landesbahn (HLB) is a regional rail operator based in Hesse, serving routes across central Germany. Owned by the State of Hesse, it operates RB and RE services connecting Frankfurt, Giessen, Fulda, Siegen, and surrounding areas.",
    ...
    annualPassengers: null,
    serviceTypes: ["regional"],
    parentCompany: "State of Hesse",
    links: [
      { label: "Official Site", url: "https://www.hlb-online.de", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Hessische_Landesbahn",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "de/odeg",
    countries: ["de"],
    bounds: [11.0, 51.3, 14.8, 53.6],
    description:
      "Ostdeutsche Eisenbahn (ODEG) is the largest private regional rail operator in eastern Germany, serving Brandenburg, Mecklenburg-Vorpommern, and Berlin. It operates RE and RB lines connecting Berlin with surrounding regions including routes to the Baltic coast and Polish border.",
    ...
    annualPassengers: null,
    serviceTypes: ["regional"],
    parentCompany: "Netinera",
    links: [
      { label: "Official Site", url: "https://www.odeg.de", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Ostdeutsche_Eisenbahn",
        type: "wikipedia",
      },
    ],
  },
  {
    slug: "stb",
    name: "Süd-Thüringen-Bahn",
    logoPath: "de/stb",
    countries: ["de"],
    bounds: [10.0, 50.2, 11.6, 50.9],
    description:
      "Süd-Thüringen-Bahn (STB) is a regional rail operator in southern Thuringia, running services on non-electrified lines in the Thuringian Forest region. It connects cities like Erfurt, Meiningen, and Eisenach with smaller towns in the area.",
    ...
    annualPassengers: null,
    serviceTypes: ["regional"],
    parentCompany: "Erfurter Bahn",
    links: [
      { label: "Official Site", url: "https://www.sued-thueringen-bahn.de", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/S%C3%BCd-Th%C3%BCringen-Bahn",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "de/vias",
    countries: ["de"],
    bounds: [7.5, 49.4, 10.0, 51.0],
    description:
      "Vias Rail is a regional rail operator in Hesse and Rhineland-Palatinate, running RB and RE services in the Rhine-Main area. It operates lines connecting Frankfurt, Mainz, Darmstadt, and Wiesbaden with the surrounding region.",
    website: "https://www.vias-online.de",
    founded: 2010,
  ...
  },
  {
    slug: "westfalenbahn",
    name: "WestfalenBahn",
    logoPath: "de/westfalenbahn",
    countries: ["de"],
    bounds: [7.0, 51.5, 11.0, 53.2],
    description:
      "WestfalenBahn is a regional rail operator in North Rhine-Westphalia and Lower Saxony, running RE and RB services connecting Bielefeld, Osnabrück, Münster, Braunschweig, and Hanover.",
    website: "https://www.westfalenbahn.de",
    founded: 2005,
    ...
    parentCompany: "BeNEX",
    links: [
      { label: "Official Site", url: "https://www.westfalenbahn.de", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/WestfalenBahn", type: "wikipedia" },
    ],
  },
  {
    slug: "vogtlandbahn",
    name: "Vogtlandbahn",
    logoPath: "de/vogtlandbahn",
    countries: ["de"],
    bounds: [11.5, 50.0, 13.0, 51.2],
    description:
      "Vogtlandbahn, operating under the Trilex and Die Länderbahn brands, is a regional rail operator in Saxony and Thuringia. It runs cross-border services into the Czech Republic and connects cities like Zwickau, Plauen, Hof, and Dresden with surrounding regions.",
    ...
    parentCompany: "Netinera",
    links: [
      { label: "Official Site", url: "https://www.laenderbahn.com", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/Vogtlandbahn", type: "wikipedia" },
    ],
  },
  {
    slug: "ns",
  ...
  },
  {
    ...
    logoPath: "uk/gw",
    countries: ["uk"],
    bounds: [-5.7, 50.1, -0.1, 52.1],
    description:
      "Great Western Railway operates intercity and regional services from London Paddington to South West England, South Wales, and the West Midlands. Its network covers some of the UK's most scenic coastal and rural routes.",
    website: "https://www.gwr.com",
    founded: 2015,
    headquarters: "Swindon, United Kingdom",
    networkKm: 2160,
    annualPassengers: 89_000_000,
    serviceTypes: ["intercity", "regional", "commuter"],
    parentCompany: "FirstGroup",
    links: [
      { label: "Official Site", url: "https://www.gwr.com", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Great_Western_Railway_(train_operating_company)",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/vt",
    countries: ["uk"],
    bounds: [-3.4, 51.5, -0.1, 55.9],
    description:
      "Avanti West Coast operates intercity services on the West Coast Main Line, connecting London Euston with Birmingham, Manchester, Liverpool, Glasgow, and Edinburgh. It took over the franchise from Virgin Trains in 2019.",
    website: "https://www.avantiwestcoast.co.uk",
    founded: 2019,
    headquarters: "Birmingham, United Kingdom",
    networkKm: 960,
    annualPassengers: 34_900_000,
    serviceTypes: ["intercity"],
    parentCompany: "FirstGroup / Trenitalia",
    links: [
      { label: "Official Site", url: "https://www.avantiwestcoast.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Avanti_West_Coast",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/gr",
    countries: ["uk"],
    bounds: [-1.6, 51.5, 0.1, 56.0],
    description:
      "London North Eastern Railway operates intercity services on the East Coast Main Line, connecting London King's Cross with Leeds, York, Newcastle, and Edinburgh using its fleet of Azuma trains.",
    website: "https://www.lner.co.uk",
    founded: 2018,
    headquarters: "York, United Kingdom",
    networkKm: 1480,
    annualPassengers: 26_600_000,
    serviceTypes: ["intercity"],
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.lner.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/London_North_Eastern_Railway",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/xc",
    countries: ["uk"],
    bounds: [-4.5, 50.4, 0.0, 57.5],
    description:
      "CrossCountry operates the most geographically extensive passenger rail franchise in the UK, connecting major cities without passing through London. Its routes link Aberdeen, Edinburgh, and Newcastle with Birmingham, Bristol, Plymouth, and Penzance.",
    website: "https://www.crosscountrytrains.co.uk",
    founded: 2007,
    headquarters: "Birmingham, United Kingdom",
    networkKm: 2560,
    annualPassengers: 37_800_000,
    serviceTypes: ["intercity", "regional"],
    parentCompany: "Arriva (I Squared Capital)",
    links: [
      { label: "Official Site", url: "https://www.crosscountrytrains.co.uk", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/CrossCountry", type: "wikipedia" },
    ],
  },
  {
    slug: "scotrail",
    ...
    logoPath: "uk/sr",
    countries: ["uk"],
    bounds: [-7.6, 54.6, -0.7, 58.7],
    description:
      "ScotRail operates the majority of passenger rail services within Scotland, connecting the Central Belt cities with the Highlands, Borders, and rural communities. It was brought under public ownership in 2022.",
    website: "https://www.scotrail.co.uk",
    founded: 2004,
    headquarters: "Glasgow, United Kingdom",
    networkKm: 2760,
    annualPassengers: 84_700_000,
    serviceTypes: ["intercity", "regional", "commuter"],
    parentCompany: "Scottish Government (public operator)",
    links: [
      { label: "Official Site", url: "https://www.scotrail.co.uk", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/ScotRail", type: "wikipedia" },
    ],
  },
  {
    slug: "emr",
    ...
    logoPath: "uk/em",
    countries: ["uk"],
    bounds: [-1.8, 51.5, 0.0, 53.5],
    description:
      "East Midlands Railway operates intercity services from London St Pancras to Sheffield, Nottingham, and Derby, as well as regional services across the East Midlands and East Anglia.",
    website: "https://www.eastmidlandsrailway.co.uk",
    founded: 2019,
    headquarters: "Derby, United Kingdom",
    networkKm: 1600,
    annualPassengers: 31_500_000,
    serviceTypes: ["intercity", "regional"],
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.eastmidlandsrailway.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/East_Midlands_Railway",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/sw",
    countries: ["uk"],
    bounds: [-3.5, 50.4, -0.1, 51.5],
    description:
      "South Western Railway operates services from London Waterloo to Surrey, Hampshire, Dorset, Devon, Somerset, and Wiltshire. It was brought into public ownership by the Department for Transport in May 2025.",
    website: "https://www.southwesternrailway.com",
    founded: 2017,
    headquarters: "London, United Kingdom",
    networkKm: 1600,
    annualPassengers: 165_600_000,
    serviceTypes: ["commuter", "regional"],
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.southwesternrailway.com", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/South_Western_Railway_(train_operating_company)",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/se",
    countries: ["uk"],
    bounds: [-0.1, 51.0, 1.4, 51.6],
    description:
      "Southeastern operates commuter and regional services in South East London, Kent, and East Sussex, including high-speed services via HS1 from London St Pancras to Ashford, Canterbury, and the Medway Towns.",
    website: "https://www.southeasternrailway.co.uk",
    founded: 2006,
    headquarters: "London, United Kingdom",
    networkKm: 960,
    annualPassengers: 137_900_000,
    serviceTypes: ["commuter", "regional"],
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.southeasternrailway.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Southeastern_(train_operating_company)",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/xr",
    countries: ["uk"],
    bounds: [-1.0, 51.4, 0.3, 51.6],
    description:
      "The Elizabeth line is a high-frequency cross-London railway connecting Reading and Heathrow in the west with Shenfield and Abbey Wood in the east. Opened in 2022, it is one of Europe's largest infrastructure projects and currently the UK's busiest railway.",
    website: "https://tfl.gov.uk/modes/elizabeth-line/",
    founded: 2022,
    headquarters: "London, United Kingdom",
    networkKm: 118,
    annualPassengers: 242_900_000,
    serviceTypes: ["commuter"],
    parentCompany: "Transport for London",
    links: [
      { label: "Official Site", url: "https://tfl.gov.uk/modes/elizabeth-line/", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Elizabeth_line",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/sn",
    countries: ["uk"],
    bounds: [-0.8, 50.7, 0.3, 51.5],
    description:
      "Southern operates commuter services across South London, Surrey, Sussex, and the South Coast, including services to Brighton, Southampton, and Gatwick Airport. It is part of the Govia Thameslink Railway (GTR) franchise.",
    website: "https://www.southernrailway.com",
    founded: 2001,
    headquarters: "London, United Kingdom",
    networkKm: 960,
    annualPassengers: 138_000_000,
    serviceTypes: ["commuter", "regional"],
    parentCompany: "Govia (Go-Ahead / Keolis)",
    links: [
      { label: "Official Site", url: "https://www.southernrailway.com", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Southern_(train_operating_company)",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/nt",
    countries: ["uk"],
    bounds: [-3.4, 53.0, -0.3, 55.5],
    description:
      "Northern Trains is the largest train operator in the North of England, running regional and commuter services across Lancashire, Yorkshire, Cumbria, and the North East. It operates over 2,500 services daily and has been under public ownership since 2020.",
    website: "https://www.northernrailway.co.uk",
    founded: 2016,
    headquarters: "Leeds, United Kingdom",
    networkKm: 2800,
    annualPassengers: 91_800_000,
    serviceTypes: ["regional", "commuter"],
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.northernrailway.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Northern_Trains",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/le",
    countries: ["uk"],
    bounds: [-0.1, 51.5, 1.8, 52.9],
    description:
      "Greater Anglia operates services from London Liverpool Street to Essex, Suffolk, Norfolk, and Cambridgeshire. It was brought into public ownership by the Department for Transport in October 2025.",
    website: "https://www.greateranglia.co.uk",
    founded: 2012,
    headquarters: "London, United Kingdom",
    networkKm: 1360,
    annualPassengers: 81_800_000,
    serviceTypes: ["intercity", "regional", "commuter"],
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.greateranglia.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Greater_Anglia",
        type: "wikipedia",
      },
    ],
  },
  {
    slug: "west-midlands-trains",
    name: "West Midlands Trains",
    logoPath: "uk/lm",
    countries: ["uk"],
    bounds: [-2.6, 51.7, -0.1, 53.0],
    description:
      "West Midlands Trains operates London Northwestern Railway and West Midlands Railway services, connecting London Euston with Birmingham, Crewe, and Liverpool. It was taken into public ownership by the Department for Transport in February 2026.",
    ...
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.westmidlandsrailway.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/West_Midlands_Trains",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/tl",
    countries: ["uk"],
    bounds: [-0.5, 50.8, 0.2, 52.2],
    description:
      "Thameslink operates cross-London services running north-south through the city centre, connecting Bedford and Cambridge with Brighton and Gatwick Airport. It is part of the Govia Thameslink Railway (GTR) franchise.",
    website: "https://www.thameslinkrailway.com",
    founded: 1988,
    headquarters: "London, United Kingdom",
    networkKm: 320,
    annualPassengers: 160_000_000,
    serviceTypes: ["commuter"],
    parentCompany: "Govia (Go-Ahead / Keolis)",
    links: [
      { label: "Official Site", url: "https://www.thameslinkrailway.com", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Thameslink",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/tp",
    countries: ["uk"],
    bounds: [-3.4, 53.0, -0.1, 54.8],
    description:
      "TransPennine Express operates intercity and express services across the North of England and into Scotland, connecting Liverpool, Manchester, Leeds, York, Newcastle, and Edinburgh. It was brought into public ownership in May 2023.",
    website: "https://www.tpexpress.co.uk",
    founded: 2004,
    headquarters: "Manchester, United Kingdom",
    networkKm: 1200,
    annualPassengers: 28_000_000,
    serviceTypes: ["intercity", "regional"],
    parentCompany: "Department for Transport (public operator)",
    links: [
      { label: "Official Site", url: "https://www.tpexpress.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/TransPennine_Express",
        type: "wikipedia",
      },
    ],
  },
  {
    slug: "london-overground",
    name: "London Overground",
    logoPath: "uk/lo",
    countries: ["uk"],
    bounds: [-0.5, 51.3, 0.2, 51.7],
    description:
      "London Overground is a suburban rail network operated by Transport for London, providing orbital and radial services across Greater London. Its lines were given individual names in 2024: Mildmay, Lioness, Windrush, Weaver, Suffragette, and Liberty.",
    website: "https://tfl.gov.uk/modes/london-overground/",
    founded: 2007,
    headquarters: "London, United Kingdom",
    networkKm: 180,
    annualPassengers: 180_000_000,
    serviceTypes: ["commuter"],
    parentCompany: "Transport for London",
    links: [
      {
  ...
  },
  {
    ...
    logoPath: "uk/cc",
    countries: ["uk"],
    bounds: [-0.1, 51.4, 0.8, 51.6],
    description:
      "c2c operates commuter services from London Fenchurch Street to Southend and towns across South Essex. It consistently ranks among the most punctual train operators in the UK.",
    website: "https://www.c2c-online.co.uk",
    founded: 1996,
    headquarters: "London, United Kingdom",
    networkKm: 120,
    annualPassengers: 40_000_000,
    serviceTypes: ["commuter"],
    parentCompany: "Trenitalia",
    links: [
      { label: "Official Site", url: "https://www.c2c-online.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/C2c_(train_operating_company)",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    description:
      "Transport for Wales operates rail services across Wales and the border regions into England, including the South Wales Main Line, Valley Lines commuter network, and the scenic Cambrian and Heart of Wales lines. It took over from Arriva Trains Wales in 2018 under Welsh Government ownership.",
    website: "https://tfw.wales",
    founded: 2018,
    headquarters: "Pontypridd, United Kingdom",
    networkKm: 1600,
    annualPassengers: 31_000_000,
    serviceTypes: ["regional", "commuter"],
    parentCompany: "Welsh Government (public operator)",
    links: [
      { label: "Official Site", url: "https://tfw.wales", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Transport_for_Wales_Rail",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "uk/ch",
    countries: ["uk"],
    bounds: [-1.3, 51.5, -0.1, 52.5],
    description:
      "Chiltern Railways operates services from London Marylebone to Birmingham, Aylesbury, and High Wycombe. Known for its consistently high customer satisfaction ratings among UK train operators.",
    website: "https://www.chilternrailways.co.uk",
    founded: 1996,
    headquarters: "London, United Kingdom",
    networkKm: 280,
    annualPassengers: 22_900_000,
    serviceTypes: ["commuter", "regional"],
    parentCompany: "Arriva (I Squared Capital)",
    links: [
      { label: "Official Site", url: "https://www.chilternrailways.co.uk", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Chiltern_Railways",
        type: "wikipedia",
      },
    ],
  },
  ...
  },
  {
    ...
    logoPath: "no/vy",
    countries: ["no", "se"],
    bounds: [4.5, 55.3, 31.5, 71.5],
    description:
      "Vy is Norway's largest passenger rail operator, running the Oslo commuter network, regional services across Eastern Norway, the Bergen Line, and several cross-border routes into Sweden. It is the successor brand to NSB and forms the core of the Norwegian passenger rail market.",
    website: "https://www.vy.no",
    founded: 1883,
    headquarters: "Oslo, Norway",
    networkKm: 3300,
    annualPassengers: 60_000_000,
    serviceTypes: ["intercity", "regional", "commuter"],
    parentCompany: "Norwegian Ministry of Transport",
    links: [
      { label: "Official Site", url: "https://www.vy.no", type: "website" },
      {
        label: "Timetables",
        url: "https://www.vy.no/en/traffic-and-routes/train-routes",
        type: "timetables",
      },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/Vy", type: "wikipedia" },
    ],
  },
  {
    slug: "sj-nord",
    ...
    logoPath: "no/sj_nord",
    countries: ["no"],
    bounds: [8.0, 58.0, 24.0, 70.8],
    description:
      "SJ NORD operates Norway's northern traffic package, including the Dovre Line, Nordland Line, Raumabanen, Roros Line, Tronder commuter rail, and related regional services. It is the Norwegian arm of SJ AB and a major long-distance operator outside the Oslo-centered Vy network.",
    website: "https://www.sj.no",
    founded: 2020,
    headquarters: "Oslo, Norway",
    networkKm: 2600,
    annualPassengers: 7_000_000,
    serviceTypes: ["intercity", "regional", "commuter", "night-train"],
    parentCompany: "SJ AB",
    links: [
      { label: "Official Site", url: "https://www.sj.no", type: "website" },
      {
        label: "Timetables",
        url: "https://www.sj.no/en/plan-your-journey/timetables",
        type: "timetables",
      },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/SJ_Norge", type: "wikipedia" },
    ],
  },
  {
    slug: "go-ahead-norge",
    name: "Go-Ahead Norge",
    logoPath: "no/go_ahead",
    countries: ["no"],
    bounds: [5.0, 58.0, 11.2, 60.5],
    description:
      "Go-Ahead Norge operates the southern traffic package, centered on the Sorland Line, Jaeren Line, and Arendal Line between Oslo, Kristiansand, Stavanger, and nearby commuter corridors. It entered the Norwegian market as the country's first competitively tendered long-distance rail operator.",
    website: "https://www.goaheadnordic.no",
    founded: 2019,
    headquarters: "Stavanger, Norway",
    networkKm: 660,
    annualPassengers: 6_000_000,
    serviceTypes: ["intercity", "regional", "commuter"],
    parentCompany: "Go-Ahead Group",
    links: [
      { label: "Official Site", url: "https://www.goaheadnordic.no", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Go-Ahead_Norge",
        type: "wikipedia",
      },
    ],
  },
  {
    slug: "flytoget",
    name: "Flytoget",
    logoPath: "no/flytoget",
    countries: ["no"],
    bounds: [10.5, 59.7, 11.3, 60.4],
    description:
      "Flytoget is Norway's dedicated airport express brand, linking Oslo city stations with Oslo Airport at high frequency using fast electric multiple units. It is one of the most recognizable rail brands in the country and focuses on premium airport access.",
    website: "https://flytoget.no",
    founded: 1992,
    headquarters: "Oslo, Norway",
    networkKm: 64,
    annualPassengers: 6_000_000,
    ...
    parentCompany: "Norwegian Ministry of Transport",
    links: [
      { label: "Official Site", url: "https://flytoget.no", type: "website" },
      {
        label: "Timetables",
        url: "https://flytoget.no/en/departures-and-arrivals/",
        type: "timetables",
      },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/Flytoget", type: "wikipedia" },
    ],
  },
  // Swedish brands
  {
    ...
    logoPath: "se/sj",
    countries: ["se"],
    bounds: [11.0, 55.3, 24.2, 69.1],
    description:
      "SJ AB is Sweden's state-owned national rail operator, running high-speed, intercity, regional, commuter, and night-train services across the country. SJ operates the tilting X 2000 and SJ 3000 long-distance trains, and since 2024 also runs Stockholm commuter rail (Stockholmståg). Its subsidiaries include SJ Götalandståg, SJ Norrlandståg, and SJ Öresundståg.",
    website: "https://www.sj.se",
    founded: 2001,
    headquarters: "Stockholm, Sweden",
    networkKm: null,
    annualPassengers: 32_000_000,
    serviceTypes: [
      "high-speed",
      "intercity",
      "regional",
    ...
    parentCompany: null,
    links: [
      { label: "Official Site", url: "https://www.sj.se", type: "website" },
      {
        label: "Timetables",
        url: "https://www.sj.se/en/travel-info/timetables",
        type: "timetables",
      },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/SJ_AB", type: "wikipedia" },
    ],
  },
  {
    slug: "mtr-express",
    ...
    logoPath: "se/mtr",
    countries: ["se"],
    bounds: [11.9, 57.7, 18.1, 59.4],
    description:
      "MTR Express was Sweden's first private open-access intercity rail operator, running frequent services between Stockholm and Göteborg. Originally a subsidiary of Hong Kong's MTR Corporation, it was acquired by VR Group in 2024 and rebranded as VR Snabbtåg.",
    website: "https://www.mtrexpress.se",
    founded: 2015,
    headquarters: "Stockholm, Sweden",
    networkKm: 455,
    annualPassengers: 2_000_000,
    serviceTypes: ["intercity"],
    parentCompany: "VR Group",
    links: [
      { label: "Official Site", url: "https://www.mtrexpress.se", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/MTR_Express", type: "wikipedia" },
    ],
  },
  {
    slug: "snalltaget",
    name: "Snälltåget",
    logoPath: "se/snalltaget",
    countries: ["se"],
    bounds: [11.0, 55.3, 24.2, 69.1],
    description:
      "Snälltåget is a Swedish open-access long-distance rail operator running intercity and night-train services, including seasonal routes to Berlin and ski trains to Åre and Swedish Lapland. It is owned by the French transport group Transdev.",
    website: "https://www.snalltaget.se",
    founded: 2006,
    headquarters: "Malmö, Sweden",
    networkKm: 1500,
    annualPassengers: 600_000,
    serviceTypes: ["intercity", "night-train", "international", "scenic"],
    parentCompany: "Transdev",
    links: [
      { label: "Official Site", url: "https://www.snalltaget.se", type: "website" },
      {
        label: "Wikipedia",
        url: "https://en.wikipedia.org/wiki/Sn%C3%A4llt%C3%A5get",
        type: "wikipedia",
      },
    ],
  },
  {
    ...
    logoPath: "transdev",
    countries: ["se", "de"],
    bounds: [5.9, 47.3, 24.2, 69.1],
    description:
      "Transdev is a global public transport operator headquartered in France, running rail, bus, tram, and ferry services across 17+ countries. In Sweden, Transdev operates regional rail services and the Snälltåget long-distance brand. In Germany, it operates as Bayerische Regiobahn (BRB), serving regional routes across Bavaria.",
    ...
    annualPassengers: null,
    serviceTypes: ["regional"],
    parentCompany: "Caisse des Dépôts / Rethmann Group",
    links: [
      { label: "Official Site", url: "https://www.transdev.com", type: "website" },
      { label: "Transdev Sweden", url: "https://www.transdev.se", type: "website" },
      { label: "BRB", url: "https://www.brb.de", type: "website" },
      { label: "Wikipedia", url: "https://en.wikipedia.org/wiki/Transdev", type: "wikipedia" },
    ],
  },
];
