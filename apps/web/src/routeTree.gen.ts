...
const MediaStationsStationIdPhotosRoute =
  MediaStationsStationIdPhotosRouteImport.update({
    id: '/media/stations/$stationId/photos',
    path: '/media/stations/$stationId/photos',
    getParentRoute: () => rootRouteImport,
  } as any)
const MediaStationsStationIdPhotoSplatRoute =
  MediaStationsStationIdPhotoSplatRouteImport.update({
