<script lang="ts">
    ...
    let {
        ...
        onLoadRemoteSource: (
            sourceId: RemoteStationSourceId,
        ) => void | Promise<void>;
    } = $props();
    ...
    <Card.Root class="w-full max-w-xl shadow-2xl">
        <Card.Header>
            ...
            <Card.Description class="leading-6">
                ...
                automatically. In deployed browser mode, start from the latest
                repository data or upload a station `.geojson`, edit it here,
                then export the updated file.
            </Card.Description>
        </Card.Header>
        ...
        <Card.Content class="space-y-5">
            ...
            <div
                class="flex items-center gap-3 text-xs uppercase text-muted-foreground"
            >
